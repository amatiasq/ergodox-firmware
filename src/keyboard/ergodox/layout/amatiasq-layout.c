...
// ----------------------------------------------------------------------------
    ...
    const uint8_t PROGMEM _kb_layout[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
      ...
      // LAYER $index
      KB_MATRIX_LAYER(0, 0, 58, 59, 60, 61, 62, 63, 43, 30, 31, 37, 38, 32, 1, 0, 47, 45, 52, 49, 48, 225, 100, 100, 47, 48, 49, 0, 224, 226, 53, 53, 0, 0, 0, 0, 0, 0, 42, 227, 41, 64, 65, 66, 67, 68, 69, 102, 1, 75, 74, 82, 77, 0, 0, 80, 80, 81, 79, 79, 40, 0, 0, 80, 78, 79, 0, 225, 127, 129, 128, 0, 226, 0, 0, 0, 0, 0, 43, 40, 44),
    ...
    const void_funptr_t PROGMEM _kb_layout_press[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
      ...
      // LAYER $index
      KB_MATRIX_LAYER(NULL, NULL, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, altprre, altprre, sshprre, sshprre, altprre, lpush1, NULL, kprrel, kprrel, altprre, altprre, kprrel, kprrel, kprrel, sshprre, altprre, altprre, kprrel, lpush0, kprrel, kprrel, kprrel, altprre, NULL, NULL, NULL, NULL, NULL, NULL, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, lpush1, kprrel, kprrel, kprrel, kprrel, NULL, NULL, guiprre, kprrel, kprrel, kprrel, guiprre, kprrel, lpush0, NULL, altprre, kprrel, altprre, NULL, kprrel, kprrel, kprrel, kprrel, NULL, kprrel, NULL, NULL, NULL, NULL, NULL, kprrel, kprrel, kprrel),
    ...
    const void_funptr_t PROGMEM _kb_layout_release[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
      ...
      // LAYER $index
      KB_MATRIX_LAYER(NULL, NULL, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, altprre, altprre, sshprre, sshprre, altprre, NULL, NULL, kprrel, kprrel, altprre, altprre, kprrel, kprrel, kprrel, sshprre, altprre, altprre, kprrel, NULL, kprrel, kprrel, kprrel, altprre, NULL, NULL, NULL, NULL, NULL, NULL, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, NULL, kprrel, kprrel, kprrel, kprrel, NULL, NULL, guiprre, kprrel, kprrel, kprrel, guiprre, kprrel, NULL, NULL, altprre, kprrel, altprre, NULL, kprrel, kprrel, kprrel, kprrel, NULL, kprrel, NULL, NULL, NULL, NULL, NULL, kprrel, kprrel, kprrel),
